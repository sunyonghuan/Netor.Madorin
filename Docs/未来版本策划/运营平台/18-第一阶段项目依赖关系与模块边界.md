...
flowchart TB
    ...
    Web[Netor.Madorin.Platform.Web]
    Admin[Netor.Madorin.Platform.Admin]

    Services[Netor.Madorin.Platform.Services]
    Entitys[Netor.Madorin.Platform.Entitys]
    Core[Netor.Madorin.Platform.Core]
...
| 项目 | 允许依赖 |
|---|---|
| Netor.Madorin.Platform.Api | Services、Entitys、Core |
| Netor.Madorin.Platform.Web | Services、Entitys、Core |
| Netor.Madorin.Platform.Admin | Services、Entitys、Core |
| Netor.Madorin.Platform.Services | Entitys、Core |
| Netor.Madorin.Platform.Entitys | Core |
| Netor.Madorin.Platform.Core | 无业务项目依赖 |

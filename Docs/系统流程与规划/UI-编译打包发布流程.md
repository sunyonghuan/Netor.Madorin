...
```powershell
powershell -ExecutionPolicy Bypass -File .\ui.package.ps1
```

可选参数：

```powershell
powershell -ExecutionPolicy Bypass -File .\ui.package.ps1 -Version 1.1.6
```
...
1. 运行 ui.publish.ps1，生成目录产物。
2. 运行 ui.package.ps1，生成 zip 和 sha256。

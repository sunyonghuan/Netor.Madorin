...
### 4.4 管理 `IChatClient` 与 HTTP 生命周期 : 0%
...
### 4.5 实现 OpenAI Responses Adapter : 0%
...
### 4.6 实现 Anthropic Messages Adapter : 0%
...
### 4.7 实现 OpenAI Compatible Adapter : 0%
...
### 4.10 控制 Experimental 与 AOT 风险 : 0%

...
> - [01-实施方案-V1](./01-实施方案-V1.md)：V1 实施范围、契约草案、阶段和验收矩阵
> - [02-架构修订-V1](./02-架构修订-V1.md)：经评审修订的协议决策，**与 01 冲突时以 02 为准**
> - [03-实现框架参考](./03-实现框架参考.md)：C# 实现时的 MAF/MEAI 使用规范
> - [04-CLI命令规范](./04-CLI命令规范.md)：所有 CLI 命令定义
> - [05-Skills加载与调用方案](./05-Skills加载与调用方案.md)：全局、工作区及远程 Skills 的来源、合并、MAF 注入和工具权限边界
>

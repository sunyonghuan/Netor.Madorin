...
3. 开启调试后复现问题，再查看 `.madorin/logs/ai-traces` 中对应 `stream-request` / `stream-error` 文件。
...
- AI trace：`Src/Netor.Madorin.AI/Providers/TokenTrackingChatClient.cs`
- HTTP trace：`Src/Netor.Madorin.AI/Drivers/UserAgentOverrideHandler.cs`
- 历史重排：`Src/Netor.Madorin.AI/Providers/ChatHistoryDataProvider.cs`
- 内容持久化：`Src/Netor.Madorin.AI/Extensions/ChatMessageExtensions.cs`
- 历史显示：`Src/Netor.Madorin.UI/Views/Main/MainWindow.Sessions.cs`
- 设置项：`Src/Netor.Madorin.Entitys/Services/SystemSettingsService.cs`

...
public sealed class PluginSettings
{
	...
	public static PluginSettings FromJson(string json)
	{
		...
		var chatWsEndpoint = GetExtension(extensions, "pluginBusEndpoint", "chatWsEndpoint");
		var conversationFeedEndpoint = GetExtension(extensions, "pluginBusEndpoint", "conversationFeedEndpoint");
		var conversationFeedProtocol = GetExtension(extensions, "pluginBusProtocol", "conversationFeedProtocol");
		var conversationFeedVersion = GetExtension(extensions, "pluginBusVersion", "conversationFeedVersion");
		var conversationFeedPort = GetExtensionInt32(extensions, "pluginBusPort", "conversationFeedPort");

using Netor.Madorin.Plugin.Native.Debugger.Discovery;
using Netor.Madorin.Plugin.Native.Debugger.Hosting;
using Netor.Madorin.Plugin.Native.Debugger.Repl;
...
public static class PluginDebugRunner
{
    ...
    private static bool IsFrameworkAssembly(string name)
    {
        return name.StartsWith("System.", StringComparison.Ordinal) ||
               ...
               name.StartsWith("Netor.Madorin.Plugin.Native", StringComparison.Ordinal) ||

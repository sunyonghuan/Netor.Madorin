...
internal static class PluginClassAnalyzer
{
    ...
    private const string RequiredHostCapabilityAttributeName = "Netor.Cortana.Plugin.RequiredHostCapabilityAttribute";
    private const string PluginSettingAttributeName = "Netor.Cortana.Plugin.PluginSettingAttribute";
    private const string PublishesEventAttributeName = "Netor.Cortana.Plugin.PublishesEventAttribute";
    private const string SubscribesEventAttributeName = "Netor.Cortana.Plugin.SubscribesEventAttribute";
    private const string ServiceCollectionInterfaceName = "Microsoft.Extensions.DependencyInjection.IServiceCollection";
    private const string PluginSettingsTypeName = "Netor.Cortana.Plugin.PluginSettings";

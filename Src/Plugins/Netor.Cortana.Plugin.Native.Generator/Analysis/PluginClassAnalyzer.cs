...
internal static class PluginClassAnalyzer
{
    ...
    private const string RequiredHostCapabilityAttributeName = "Netor.Cortana.Plugin.Native.RequiredHostCapabilityAttribute";
    private const string LegacyRequiredHostCapabilityAttributeName = "Netor.Cortana.Plugin.RequiredHostCapabilityAttribute";
    private const string PluginSettingAttributeName = "Netor.Cortana.Plugin.Native.PluginSettingAttribute";
    private const string LegacyPluginSettingAttributeName = "Netor.Cortana.Plugin.PluginSettingAttribute";
    private const string PublishesEventAttributeName = "Netor.Cortana.Plugin.Native.PublishesEventAttribute";
    private const string SubscribesEventAttributeName = "Netor.Cortana.Plugin.Native.SubscribesEventAttribute";

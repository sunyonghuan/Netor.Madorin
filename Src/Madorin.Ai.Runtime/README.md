...
2. [实施方案 V1](../../Docs/未来策划/独立CLI/01-实施方案-V1.md)
3. [架构修订 V1](../../Docs/未来策划/独立CLI/02-架构修订-V1.md)
4. [实现框架参考](../../Docs/未来策划/独立CLI/03-实现框架参考.md)
5. [CLI 命令规范](../../Docs/未来策划/独立CLI/04-CLI命令规范.md)
